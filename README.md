...
What I would like to do in the future is to re-generate the voiceovers so that male and female NPCs would use different narrator voices. In even further future, it would be nice to generate voiceovers for different races and body types (learning how to train my own voices at the moment during my free time).
